...
const mapStateToProps =(stores)=> {
    ...
    return {
        ...
        name:stores.user.stores.realticket.name,
        movieName:stores.user.stores.realticket.movieName,
        TheatreName:stores.user.stores.realticket.TheatreName,
        total_amount:stores.user.stores.realticket.total_amount,
        children:stores.user.stores.realticket.children,
        student:stores.user.stores.realticket.student,
        general:stores.user.stores.realticket.general,
        message : "success"
    };
}
