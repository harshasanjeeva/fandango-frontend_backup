        ...
        return movies.map((movie) => {
            return (
                <ListGroupItem action
                               key={movie.hallId} style={{backgroundColor:"black"}}>
                    <img src={movie.movieimage}/>
                    <div >

                     <div>
                        <strong style={{color:"silver"}}>{movie.moviename}</strong>
                     </div>
                        ...
                        <span style={{color:"silver"}}>{movie.movieTiming}</span>
            ...
            <div style={{backgroundColor:"black",height:"1000px"}}>
                ...
                <div>
                    <Card style={{backgroundColor:"black"}}>
                        ...
                        <CardBody>
                            <CardTitle><strong style={{color:"orange"}}>Hall Name:</strong> <span style={{color:"silver"}}>{this.state.hall_name}</span></CardTitle>
                            <CardTitle><strong style={{color:"orange"}}>Hall Address:</strong>  <span style={{color:"silver"}}> {this.state.hall_address}</span></CardTitle>
<h5 style={{color:"silver"}}> Now Showing</h5>
                        </CardBody>
                    </Card>
                </div>
