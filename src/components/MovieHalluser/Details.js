                ...
                <div className="row">
                    ...
                    <div className="col-md-4" align="left" >
                        <div className="col-md-12" align="left">
                            <Card>
                                <CardImg top width="100%" src={location.state.movieimage} height="300px" width="180px" />
                                <CardBody>
                                    ...
                                    <CardTitle><strong>Timings: </strong> {location.state.time1} {location.state.time2} {location.state.time3} {location.state.time4} {location.state.time5} </CardTitle>
                                    <CardTitle><strong>Tickets: </strong>{location.state.tickets}</CardTitle>
                                    <CardTitle><strong>screen: </strong>{location.state.screen}</CardTitle>
                                    <CardTitle><strong>Price: </strong>{location.state.price}$</CardTitle>
